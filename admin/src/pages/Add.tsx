...
const Add = ({ token }: AddProps) => {
  ...
  const onSubmitHandler = async (e: React.FormEvent) => {
    ...
    image3 && formData.append("image3", image3 as Blob);
    image4 && formData.append("image4", image4 as Blob);

    const response = await axios.post(
      server_url + "/api/product/add",
      formData,
      { headers: { token } }
    );
    ...
    >
      <div>
        ...
        <div className="flex gap-2">
          <label htmlFor="image1">
            ...
            />
            <input
              onChange={(e) => setImage1(e.target.files && e.target.files[0])}
              type="file"
              id="image1"
              hidden
            />
          ...
          <label htmlFor="image2">
            ...
            />
            <input
              onChange={(e) => setImage2(e.target.files && e.target.files[0])}
              type="file"
              id="image2"
              hidden
            />
          ...
          <label htmlFor="image3">
            ...
            />
            <input
              onChange={(e) => setImage3(e.target.files && e.target.files[0])}
              type="file"
              id="image3"
              hidden
            />
          ...
          <label htmlFor="image4">
            ...
            />
            <input
              onChange={(e) => setImage4(e.target.files && e.target.files[0])}
              type="file"
              id="image4"
              hidden
            />
      ...
      <div>
        ...
        <div className="flex gap-3">
          {/* <div onClick={() => setSizes((prev) => [...prev, "XS"])}>
            <p className="bg-slate-200 px-3 py-1 cusor-pointer">XS</p>
          </div> */}
